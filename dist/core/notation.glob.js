...
var _notation = _interopRequireDefault(require("./notation"));

var _notation2 = _interopRequireDefault(require("./notation.error"));
...
function () {
  ...
  _createClass(NotationGlob, [{
    ...
    value: function test(notation) {
      if (!_notation.default.isValid(notation)) {
        throw new _notation2.default("Invalid notation: '".concat(notation, "'"));
    ...
    value: function toRegExp(glob) {
      if (!NotationGlob.isValid(glob)) {
        throw new _notation2.default("".concat(ERR_INVALID, " '").concat(glob, "'"));
      }

      var g = glob.indexOf('!') === 0 ? glob.slice(1) : glob;
      g = _utils.default.pregQuote(g) // `[*]` always represents array index e.g. `[1]`. so we'd replace
    ...
    value: function _intersect(globA, globB) {
      ...
      if (notesI.length > 0) return bang + _utils.default.joinNotes(notesI);
      return null;
    }
    /**
     *  Undocumented.
    ...
    value: function _inspect(glob) {
      var g = _utils.default.normalizeGlobStr(glob);
    ...
    value: function split(glob) {
      ...
      var g = normalize ? _utils.default.normalizeGlobStr(glob) : glob;
    ...
    value: function normalize(globList) {
      ...
      var original = _utils.default.ensureArray(globList);
      ...
      _utils.default.eachRight(list, function (a, indexA) {
        ...
        _utils.default.eachRight(list, function (b, indexB) {
    ...
    value: function _compareUnion(globsListA, globsListB, restrictive) {
      ...
      _utils.default.eachRight(globsListA, function (globA) {
        ...
        _utils.default.eachRight(globsListB, function (globB) {
...
var _default = NotationGlob;
exports.default = _default;
//# sourceMappingURL=notation.glob.js.map